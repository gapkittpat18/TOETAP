# TOETAP — Strava-first, but not Strava-required

## Product rule
When Strava is connected, Strava is the default/primary source across TOETAP:
- Recent runs
- Run history
- Distance / pace / time
- Shoe mileage
...
TOETAP DB does NOT replace Strava as the primary data source for a connected user.
...
V1: Strava primary.
No Strava: TOETAP local fallback.
