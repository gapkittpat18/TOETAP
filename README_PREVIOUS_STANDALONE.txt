TOETAP V1.1 — Standalone Core
================================
Goal: TOETAP works without a Strava account.

INSTALL
1. Overlay this package on the current TOETAP folder.
...
- Insights now reads TOETAP's local activities table, not live Strava.
